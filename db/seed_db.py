...
db.demoCommunity.insert_one(community_doc)
db.demoMod1.insert_one(mod1_doc)
db.demoMod2.insert_one(mod2_doc)
db.demoMod3.insert_one(mod3_doc)
db.demoMod4.insert_one(mod4_doc)
